...
Original file is located at
    https://colab.research.google.com/drive/13ANk_frr_y1LS-zLD-mpLXOSfbXszwX6
"""
...
def img_loader(path):
    def loader(transform):
        ...
        data_loader = DataLoader(data, shuffle=True, batch_size=batch_size, num_workers=n_workers)

        return data_loader

    return loader

def sample_data(dataloader, image_size=image_size):
