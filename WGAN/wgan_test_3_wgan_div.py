...
# Loss weight for gradient penalty for WGAN-gp
lambda_gp = 10
...
# criterion = nn.BCELoss() # for DCGAN
...
def compute_gradient_penalty(netD, real_data, fake_data):
    ...
    gradient_penalty = torch.pow(gradients.norm(2, dim=1), p).mean()
    gradient_penalty = k * gradient_penalty
